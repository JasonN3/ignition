...
:fcos
kernel https://builds.coreos.fedoraproject.org/prod/streams/${channel}/builds/${version}/x86_64/fedora-coreos-${version}-live-kernel-x86_64 rd.neednet=1 console=tty0 initrd=main coreos.live.rootfs_url=https://builds.coreos.fedoraproject.org/prod/streams/${channel}/builds/${version}/x86_64/fedora-coreos-${version}-live-rootfs.x86_64.img coreos.inst.install_dev=/dev/sda coreos.inst.ignition_url=${base}/fcos/ignition.php coreos.inst.image_url=https://builds.coreos.fedoraproject.org/prod/streams/${channel}/builds/${version}/x86_64/fedora-coreos-${version}-metal.x86_64.raw.xz coreos.inst.copy-network
